...
- `smoke_test.py` now ships in the source distribution. The script is referenced from the README's performance table and was reachable via the GitHub repo, but a sdist-only consumer (e.g. `pip download`) didn't get it.
